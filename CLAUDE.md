# Flash Cards iOS/TCA開発ガイド

Flash Cardsアプリ専門のiOS/TCA開発ガイドです。The Composable Architecture、SwiftUI、Realmを使用したフラッシュカードアプリの開発をサポートします。
...
このガイドは、Flash Cardsプロジェクトの確立されたパターンとベストプラクティスに従い、TCA + Realmの統合を考慮した高品質なiOSコードを生成するためのリファレンスです。
